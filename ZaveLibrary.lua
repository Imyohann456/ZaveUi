...
local Utility = {}
local Objects = {}
function Zave:DraggingEnabled(frame, parent)
...
local Name = "ZaveLibrary.JSON"
if not isfile("ZaveLibrary.JSON") then
   writefile(Name, "{}") 
end
pcall(function()
...
function Zave.CreateLib(ZavName, themeList)
    ...
    local selectedTab 
    ZavName = ZavName or "Library"
    table.insert(Zave, ZavName)
    for i,v in pairs(game.CoreGui:GetChildren()) do
        if v:IsA("ScreenGui") and v.Name == ZavName then
            v:Destroy()
        end
    end
    ...
    Zave:DraggingEnabled(MainHeader, Main)
    ...
    function Zave:ChangeColor(prope,color)
